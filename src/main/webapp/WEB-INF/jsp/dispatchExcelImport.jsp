                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                           <!--  <li><a href="productionPlan"><i class="fa fa-circle-o"></i>Production Plan</a></li>--->
                                                    <li class="active"><a href="insertProduction"><i class="fa fa-circle-o"></i>Insert Product</a></li>
...
<div class="container" style="width:500px; margin-top:20px;">
  <div class="jumbotron" style="background: #3c8dbc;">
    <h1 class="pb-5">Import Dispatch Plan</h1>
...
'use strict';
    function uploadSingleFile() {
        ...
        xhr.open("POST", gUrl.url+"/uploadDispatchPlan");
        ...
        xhr.onload = function() {
            ...
            document.getElementById("loader").style.display="none";
            alert("Please Check Your Quantity!!! You have planned more than your existing Quantity.")
            window.location.reload();
