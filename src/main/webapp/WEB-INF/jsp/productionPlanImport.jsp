                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                            <!-- <li><a href="productionPlan"><i class="fa fa-circle-o"></i>Production Plan</a></li>--->
                                                  <li class="active"><a href="#" title="This Option is disable"><i class="fa fa-circle-o"></i>Manual Insert Product</a></li>
...
<div class="container" style="width:500px; margin-top:20px;">
  <div class="jumbotron" style="background: #3c8dbc;">
    <h1 class="pb-5">Import Production Plan</h1>
...
'use strict';
    function uploadSingleFile() {
        ...
        xhr.open("POST", gUrl.url+"/uploadProductionExcel");
