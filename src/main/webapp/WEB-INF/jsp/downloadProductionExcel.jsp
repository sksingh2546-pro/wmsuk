...
<div class="container" style="width:500px; margin-top:20px;">
  <div class="jumbotron" style="background: #3c8dbc;">
    <h1 class="pb-5">Download Production</h1>
...
window.location.href="/api/generateProdExcel?date="+document.getElementById("date").value+"&to="+document.getElementById("to").value;
