                    ...
                    <div class="form-login-error">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="user_name" id="user_name" placeholder="Enter User Id..." autocomplete="off" />
                            </div>
                        ...
                        <div class="form-group">
                            <button type="submit" onclick="login()" class="btn btn-primary btn-block btn-login">
...
localStorage.setItem("user_id",document.getElementById("user_name").value);
