var gBayList=[];
 ...
 function getSkuList(){
 	...
 	XHR.open("GET", gUrl.url+"/getAllSku", true);
 ...
 function insertPurchaseOrder(){
 	...
 	var batch_no=document.getElementsByName("batch_no[]");
        ...
        for(;i< sku.length; i++){
                 ...
                 console.log(hash);
         		XHR2.open("POST", gUrl.url+"/updateManualProductionOrder");
        ...
        if(i>0){
       /*  alert("Successfully Order Dispatch")*/
        Toastify({
                           text: "Successfully Order Dispatch ",
                           duration: 3000,
                           gravity: "top",
                           position: 'center',
